...
public class ComponentInPlaceMojoTest
    extends AbstractComponentMojoTest
{
    ...
    private ComponentInPlaceMojo mojo;
        ...
        throws Exception
    {
        ...
        mojo = (ComponentInPlaceMojo) lookupMojo( "inplace", pomFilePath );
        assertNotNull( mojo );
    }
        ...
        throws Exception
    {
        ...
        this.configureMojo( mojo, new LinkedList(), classesDir, webAppSource, null, null, project );
