...
public class ComponentDeployExplodedMojoTest
    extends AbstractComponentMojoTest
{
    protected static final String pomFilePath =
        getBasedir() + "/target/test-classes/unit/wardeployexplodedmojo/plugin-config.xml";

    private ComponentDeployExplodedMojo mojo;
    ...
    protected File getTestDirectory()
        throws Exception
    {
        return new File( getBasedir(), "target/test-classes/unit/wardeployexplodedmojo/test-dir" );
    }
        ...
        throws Exception
    {
        ...
        mojo = (ComponentDeployExplodedMojo) lookupMojo( "deploy-exploded", pomFilePath );
     ...
     * @throws Exception
     */
    public void testWebappDeployExplodedWar()
        throws Exception
    {
        // setup test data
        String testId = "SimpleDeployExplodedWebApp";
