...
import org.sakaiproject.maven.plugin.component.stub.EJBArtifactStub;
import org.sakaiproject.maven.plugin.component.stub.EJBClientArtifactStub;
import org.sakaiproject.maven.plugin.component.stub.IncludeExcludeWarArtifactStub;
import org.sakaiproject.maven.plugin.component.stub.JarArtifactStub;
import org.sakaiproject.maven.plugin.component.stub.MavenProjectArtifactsStub;
import org.sakaiproject.maven.plugin.component.stub.MavenProjectBasicStub;
import org.sakaiproject.maven.plugin.component.stub.PARArtifactStub;
...
import org.sakaiproject.maven.plugin.component.stub.TLDArtifactStub;
import org.sakaiproject.maven.plugin.component.stub.EJBArtifactStubWithClassifier;
...
public class ComponentExplodedMojoTest
    extends AbstractComponentMojoTest
{
    ...
    private ComponentExplodedMojo mojo;
        ...
        throws Exception
    {
        ...
        mojo = (ComponentExplodedMojo) lookupMojo( "exploded", pomFilePath );
        assertNotNull( mojo );
    }
    ...
    {
        // setup test data
        String testId = "SimpleExplodedComponent";
        ...
        throws Exception
    {
        ...
        this.configureMojo( mojo, filterList, classesDir, webAppSource, webAppDirectory, null, project );
        setVariableValueToObject( mojo, "webResources", resources );
        mojo.execute();
